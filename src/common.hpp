...
enum class COLLISION_TYPE {
	...
	CROSSHAIR_INTERACTABLE = CROSSHAIR_TEXTURED_UI_ELEMENT + 1,
	COLLISION_COUNT = CROSSHAIR_INTERACTABLE + 1
};
...
enum class ROOM_TYPE {
	...
	BILLYBOY_ROOM = OLD_ROBOT_ROOM + 1,
	TWO_SIMPLE = BILLYBOY_ROOM + 1,
...
enum class NPC_TYPE {
	OLD_ROBOT_NPC = 0,
	BILLYBOY_NPC = OLD_ROBOT_NPC + 1,
	SCARECROW_NPC = BILLYBOY_NPC + 1,
